...
var $author$project$Main$Component__Button = {$: 'Component__Button'};
var $author$project$Main$Component__Collapsible = {$: 'Component__Collapsible'};
var $author$project$Main$Component__ProductCard = {$: 'Component__ProductCard'};
var $author$project$Main$allComponents = _List_fromArray(
	[$author$project$Main$Component__Button, $author$project$Main$Component__Collapsible, $author$project$Main$Component__ProductCard]);
...
var $author$project$Main$buttonCodeExample = A3($elm$core$String$replace, '    ', '\t', 'import View.Button as Button\nimport View.Button.Big as BigButton\n\n\nbuttons : List (Html Msg)\nbuttons =\n    [ Html.div\n        [ Attr.css\n            [ S.row\n            , S.g4\n            ]\n        ]\n        [ Button.primary "Hello" ClickedHello\n            |> Button.disable False\n            |> Button.toHtml\n        , Button.primary "Hi" ClickedHello\n            |> Button.toHtml\n        , Button.secondary "Show more +" ClickedShowMore\n            |> Button.toHtml\n        ]\n    , Html.div\n        [ Attr.css\n            [ S.w64\n            ]\n        ]\n        [ BigButton.primary "ADD TO CART" ClickedAddToCart\n            |> BigButton.toHtml\n        ]\n    ]\n');
var $author$project$Main$collapsibleCodeExample = A3($elm$core$String$replace, '    ', '\t', 'import View.Collapsible as Collapsible\n    \nhtml = \n    let \n        collapsibleHtml : Html Msg\n        collapsibleHtml =\n            Collapsible.simple\n                "TEXT"\n                { isOpen = isOpen }\n                ClickedTextCollapsible\n                |> Collapsible.toHtml\n\n        content : List (Html Msg)\n        content =\n            if isOpen then\n                [ Html.text "Peekaboo" ]\n\n            else\n                []\n    in \n    Html.div\n        [ Attr.css\n            [ S.borderT\n            , borderColor\n            , S.p2\n            ]\n        ]\n        (collapsible :: content)\n    \n');
var $author$project$Main$ClickedAddToCart = {$: 'ClickedAddToCart'};
var $author$project$Main$ClickedHello = {$: 'ClickedHello'};
var $author$project$Main$CE__Filter = {$: 'CE__Filter'};
var $author$project$Main$CE__Text = {$: 'CE__Text'};
var $author$project$Main$allCollapsibleExamples = _List_fromArray(
	[$author$project$Main$CE__Text, $author$project$Main$CE__Filter]);
var $author$project$Main$Product__Bag = {$: 'Product__Bag'};
var $author$project$Main$Product__PhoneCase = {$: 'Product__PhoneCase'};
var $author$project$Main$Product__Wallet = {$: 'Product__Wallet'};
var $author$project$Main$allProducts = _List_fromArray(
	[$author$project$Main$Product__PhoneCase, $author$project$Main$Product__Bag, $author$project$Main$Product__Wallet]);
var $rtfeldman$elm_css$Css$borderBottom2 = $rtfeldman$elm_css$Css$prop2('border-bottom');
var $author$project$Style$borderB = A2(
...
var $author$project$Style$gray3 = A3($rtfeldman$elm_css$Css$rgb, 219, 219, 219);
var $author$project$Style$borderGray3 = $rtfeldman$elm_css$Css$borderColor($author$project$Style$gray3);
var $author$project$Main$borderColor = $author$project$Style$borderGray3;
var $author$project$Main$ClickedCollapsible = function (a) {
	return {$: 'ClickedCollapsible', a: a};
};
var $rtfeldman$elm_css$Css$borderTop2 = $rtfeldman$elm_css$Css$prop2('border-top');
var $author$project$Style$borderT = A2(
	$rtfeldman$elm_css$Css$borderTop2,
	$rtfeldman$elm_css$Css$px(1),
	$rtfeldman$elm_css$Css$solid);
...
var $author$project$Style$g2 = A2($rtfeldman$elm_css$Css$property, 'gap', '0.5rem');
...
var $author$project$Style$py2 = $rtfeldman$elm_css$Css$batch(
	_List_fromArray(
		[
			$rtfeldman$elm_css$Css$paddingTop($author$project$Style$s2),
			$rtfeldman$elm_css$Css$paddingBottom($author$project$Style$s2)
		]));
...
var $author$project$View$Collapsible$simple = F3(
	function (label, rec, msg) {
		return {isOpen: rec.isOpen, label: label, onClick: msg};
	});
...
var $author$project$Style$hAuto = $rtfeldman$elm_css$Css$height($rtfeldman$elm_css$Css$auto);
...
var $author$project$View$Collapsible$chevronUpSvg = A2(
	...
	_List_fromArray(
		[
			...
			_List_fromArray(
				[$author$project$Style$wFull, $author$project$Style$hAuto]))
		]),
	_List_fromArray(
		[
			A2(
			...
			_List_fromArray(
				[
					$rtfeldman$elm_css$Svg$Styled$Attributes$d('M6 9l6 6 6-6'),
...
var $author$project$Style$h4 = $rtfeldman$elm_css$Css$height($author$project$Style$s4);
...
var $author$project$Style$gray0 = A3($rtfeldman$elm_css$Css$rgb, 51, 51, 51);
var $author$project$Style$textGray0 = $rtfeldman$elm_css$Css$color($author$project$Style$gray0);
...
var $author$project$Style$w4 = $rtfeldman$elm_css$Css$width($author$project$Style$s4);
var $author$project$View$Collapsible$toHtml = function (collapsible) {
	var icon = $author$project$View$Collapsible$chevronUpSvg;
	var topRow = A2(
		...
		_List_fromArray(
			[
				...
				_List_fromArray(
					[$author$project$Style$row, $author$project$Style$justifySpaceBetween, $author$project$Style$itemsCenter]))
			]),
		_List_fromArray(
			[
				A2(
				...
				_List_fromArray(
					[
						$rtfeldman$elm_css$Html$Styled$Attributes$css(
						_List_fromArray(
							[$author$project$Style$textGray0]))
					]),
				_List_fromArray(
					[
						$rtfeldman$elm_css$Html$Styled$text(collapsible.label)
					])),
				A2(
				$rtfeldman$elm_css$Html$Styled$div,
				_List_fromArray(
					[
						...
						_List_fromArray(
							[
								$author$project$Style$w4,
								$author$project$Style$h4,
								$rtfeldman$elm_css$Css$transform(
								$rtfeldman$elm_css$Css$rotate(
									$rtfeldman$elm_css$Css$deg(
										collapsible.isOpen ? 0 : 180))),
								A2($rtfeldman$elm_css$Css$property, 'transition', 'transform 0.2s ease')
							]))
					]),
				_List_fromArray(
					[icon]))
	...
	return A2(
		...
		_List_fromArray(
			[
				$rtfeldman$elm_css$Html$Styled$Attributes$css(
				_List_fromArray(
					[$author$project$Style$col, $author$project$Style$pointerCursor])),
				$rtfeldman$elm_css$Html$Styled$Events$onClick(collapsible.onClick)
			]),
		_List_fromArray(
			[topRow]));
};
...
var $author$project$Main$collapsibleExampleView = F2(
	function (openCollapsibles, example) {
		var msg = $author$project$Main$ClickedCollapsible(example);
		var label = function () {
			if (example.$ === 'CE__Text') {
				return 'TEXT';
			} else {
		...
		var isOpen = A2($elm$core$List$member, example, openCollapsibles);
		var content = function () {
			if (isOpen) {
				if (example.$ === 'CE__Filter') {
					var filterView = function (text) {
						return A2(
							$rtfeldman$elm_css$Html$Styled$div,
							_List_fromArray(
								[
									$rtfeldman$elm_css$Html$Styled$Attributes$css(
									_List_fromArray(
										[$author$project$Style$g4, $author$project$Style$row, $author$project$Style$itemsCenter]))
								]),
							_List_fromArray(
								[
									A2(
						...
						[
							...
							_List_fromArray(
								[
									$rtfeldman$elm_css$Html$Styled$Attributes$css(
									_List_fromArray(
										[$author$project$Style$g2, $author$project$Style$py2, $author$project$Style$col]))
								]),
							A2(
								$elm$core$List$map,
								filterView,
								_List_fromArray(
									['10+ cards', '5 - 10 cards', '<5 cards', 'Flat bills'])))
						]);
				} else {
					return _List_fromArray(
						[
							$rtfeldman$elm_css$Html$Styled$text('Peekaboo')
						]);
				}
			} else {
				return _List_Nil;
		...
		var collapsible = $author$project$View$Collapsible$toHtml(
			A3(
				$author$project$View$Collapsible$simple,
				label,
				{isOpen: isOpen},
				msg));
		return A2(
			...
			_List_fromArray(
				[
					$rtfeldman$elm_css$Html$Styled$Attributes$css(
					_List_fromArray(
						[$author$project$Style$borderT, $author$project$Main$borderColor, $author$project$Style$p2]))
				]),
			A2($elm$core$List$cons, collapsible, content));
	});
var $author$project$View$Button$disable = F2(
	function (b, button) {
		return button;
	});
...
var $author$project$View$Button$Common$Primary = {$: 'Primary'};
var $author$project$View$Button$make = F3(
	function (label, msg, variant) {
		return {label: label, onClick: msg, variant: variant};
	});
var $author$project$View$Button$primary = F2(
	function (label, msg) {
		return A3($author$project$View$Button$make, label, msg, $author$project$View$Button$Common$Primary);
	});
var $author$project$View$Button$Big$primary = F2(
	function (label, msg) {
		return {label: label, onClick: msg};
	});
var $author$project$Main$BCO__Maroon = {$: 'BCO__Maroon'};
var $author$project$Main$BCO__Teal = {$: 'BCO__Teal'};
var $author$project$Main$ClickedBagColorOption = function (a) {
	return {$: 'ClickedBagColorOption', a: a};
};
var $author$project$Main$ClickedPhoneCaseColorOption = function (a) {
	return {$: 'ClickedPhoneCaseColorOption', a: a};
};
var $author$project$Main$ClickedWalletColorOption = function (a) {
	return {$: 'ClickedWalletColorOption', a: a};
};
var $author$project$Main$PCCO__Blue = {$: 'PCCO__Blue'};
var $author$project$Main$PCCO__Green = {$: 'PCCO__Green'};
var $author$project$Main$PCCO__Red = {$: 'PCCO__Red'};
var $author$project$Main$WCO__Brown = {$: 'WCO__Brown'};
var $author$project$Main$WCO__Gray = {$: 'WCO__Gray'};
var $author$project$View$ProductCard$Color__Dark = {$: 'Color__Dark'};
var $author$project$View$ProductCard$asDark = function (pc) {
	return _Utils_update(
		pc,
		{color: $author$project$View$ProductCard$Color__Dark});
};
var $author$project$View$ProductCard$Swatch$V__Color = function (a) {
	return {$: 'V__Color', a: a};
};
var $author$project$View$ProductCard$Swatch$color = function (rec) {
	var _v0 = rec.rgb;
	var r = _v0.a;
	var g = _v0.b;
	var b = _v0.c;
	return {
		...
		value: $author$project$View$ProductCard$Swatch$V__Color(
			{b: b, g: g, r: r})
	};
};
var $author$project$View$ProductCard$Color__Light = {$: 'Color__Light'};
var $author$project$View$ProductCard$default = {color: $author$project$View$ProductCard$Color__Light, hoverOverChip: $elm$core$Maybe$Nothing};
var $author$project$Style$gray1 = A3($rtfeldman$elm_css$Css$rgb, 78, 78, 78);
var $author$project$Style$textGray1 = $rtfeldman$elm_css$Css$color($author$project$Style$gray1);
...
var $author$project$View$ProductCard$descriptionView = function (description) {
	return A2(
		$rtfeldman$elm_css$Html$Styled$div,
		_List_fromArray(
			[
				$rtfeldman$elm_css$Html$Styled$Attributes$css(
				_List_fromArray(
					[$author$project$Style$wFull, $author$project$Style$textSm, $author$project$Style$textGray1]))
			]),
		_List_fromArray(
			[
...
var $author$project$Style$bgTeal = $rtfeldman$elm_css$Css$backgroundColor(
	A3($rtfeldman$elm_css$Css$rgb, 108, 184, 200));
...
var $author$project$Style$pr2 = $rtfeldman$elm_css$Css$paddingRight($author$project$Style$s2);
var $author$project$Style$px2 = $rtfeldman$elm_css$Css$batch(
	_List_fromArray(
		[$author$project$Style$pl2, $author$project$Style$pr2]));
var $author$project$Style$s1 = $rtfeldman$elm_css$Css$rem(0.25);
var $author$project$Style$py1 = $rtfeldman$elm_css$Css$batch(
	_List_fromArray(
		[
			$rtfeldman$elm_css$Css$paddingTop($author$project$Style$s1),
			$rtfeldman$elm_css$Css$paddingBottom($author$project$Style$s1)
		]));
var $rtfeldman$elm_css$Css$borderRadius = $rtfeldman$elm_css$Css$prop1('border-radius');
var $author$project$Style$roundingSize = $rtfeldman$elm_css$Css$rem(0.375);
var $author$project$Style$rounded = $rtfeldman$elm_css$Css$borderRadius($author$project$Style$roundingSize);
var $author$project$Style$textWhite = $rtfeldman$elm_css$Css$color(
	A3($rtfeldman$elm_css$Css$rgb, 255, 255, 255));
var $author$project$View$ProductCard$newChip = A2(
	$rtfeldman$elm_css$Html$Styled$div,
	_List_fromArray(
		[
			$rtfeldman$elm_css$Html$Styled$Attributes$css(
			_List_fromArray(
				[$author$project$Style$bgTeal, $author$project$Style$rounded, $author$project$Style$px2, $author$project$Style$py1, $author$project$Style$textWhite, $author$project$Style$textSm]))
		]),
	_List_fromArray(
		[
			$rtfeldman$elm_css$Html$Styled$text('New')
		]));
var $author$project$View$ProductCard$priceView = function (price) {
	return A2(
		$rtfeldman$elm_css$Html$Styled$div,
		_List_fromArray(
			[
...
var $author$project$Style$gray2 = A3($rtfeldman$elm_css$Css$rgb, 201, 201, 201);
var $author$project$Style$bgGray2 = $rtfeldman$elm_css$Css$backgroundColor($author$project$Style$gray2);
var $author$project$Style$p1 = $rtfeldman$elm_css$Css$padding($author$project$Style$s1);
var $author$project$View$ProductCard$showInsideChip = A2(
	$rtfeldman$elm_css$Html$Styled$div,
	_List_fromArray(
		[
			$rtfeldman$elm_css$Html$Styled$Attributes$css(
			_List_fromArray(
				[$author$project$Style$bgGray2, $author$project$Style$rounded, $author$project$Style$p1]))
		]),
	_List_fromArray(
		[
			$rtfeldman$elm_css$Html$Styled$text('SHOW INSIDE +')
		]));
var $author$project$View$ProductCard$Image$simple = function (src) {
	return {chip: $elm$core$Maybe$Nothing, src: src};
};
...
var $author$project$Style$cursorPointer = $rtfeldman$elm_css$Css$cursor($rtfeldman$elm_css$Css$pointer);
var $author$project$Style$roundedFull = $rtfeldman$elm_css$Css$borderRadius(
	$rtfeldman$elm_css$Css$pct(50));
var $author$project$View$ProductCard$Swatch$toHtml = function (swatch) {
	var selectedCircle = swatch.selected ? A2(
		$rtfeldman$elm_css$Html$Styled$div,
		_List_fromArray(
			[
				$rtfeldman$elm_css$Html$Styled$Attributes$css(
				_List_fromArray(
					[
						$author$project$Style$roundedFull,
						A3(
	...
	var bg = function () {
		var _v0 = swatch.value;
		var r = _v0.a.r;
		var g = _v0.a.g;
		var b = _v0.a.b;
		return $rtfeldman$elm_css$Css$backgroundColor(
			A3($rtfeldman$elm_css$Css$rgb, r, g, b));
	}();
	return A2(
		$rtfeldman$elm_css$Html$Styled$div,
		_List_fromArray(
			[
				...
				_List_fromArray(
					[
						...
						$author$project$Style$h4,
						bg,
						$author$project$Style$cursorPointer,
						$author$project$Style$roundedFull,
						$rtfeldman$elm_css$Css$padding(
						$rtfeldman$elm_css$Css$px(1)),
						$author$project$Style$row
					])),
				$rtfeldman$elm_css$Html$Styled$Events$onClick(swatch.onClick)
			]),
		_List_fromArray(
			[selectedCircle]));
};
var $author$project$View$ProductCard$swatchesView = function (swatches) {
	return A2(
		$rtfeldman$elm_css$Html$Styled$div,
		_List_fromArray(
			[
				$rtfeldman$elm_css$Html$Styled$Attributes$css(
				_List_fromArray(
					[$author$project$Style$wFull, $author$project$Style$g2, $author$project$Style$row]))
			]),
		A2($elm$core$List$map, $author$project$View$ProductCard$Swatch$toHtml, swatches));
};
var $author$project$View$ProductCard$titleView = function (title) {
	return A2(
		$rtfeldman$elm_css$Html$Styled$div,
		_List_fromArray(
			[
...
var $author$project$Style$bottom0 = $rtfeldman$elm_css$Css$bottom($rtfeldman$elm_css$Css$zero);
var $rtfeldman$elm_css$Css$cover = {lengthOrAutoOrCoverOrContain: $rtfeldman$elm_css$Css$Structure$Compatible, value: 'cover'};
var $author$project$Style$s64 = $rtfeldman$elm_css$Css$rem(16);
var $author$project$Style$h64 = $rtfeldman$elm_css$Css$height($author$project$Style$s64);
...
var $author$project$Style$w64 = $rtfeldman$elm_css$Css$width($author$project$Style$s64);
var $author$project$View$ProductCard$Image$toHtml = function (image) {
			...
			return A2(
				...
				_List_fromArray(
					[
						$rtfeldman$elm_css$Html$Styled$Attributes$css(
						_List_fromArray(
							[$author$project$Style$absolute, $author$project$Style$bottom0, $author$project$Style$left0]))
					]),
				_List_fromArray(
					[chip]));
		} else {
	...
	return A2(
		...
		_List_fromArray(
			[
				$rtfeldman$elm_css$Html$Styled$Attributes$css(
				_List_fromArray(
					[$author$project$Style$relative, $author$project$Style$row, $author$project$Style$justifyCenter, $author$project$Style$wFull]))
			]),
		_List_fromArray(
			[
				A2(
					...
					[
						...
						_List_fromArray(
							[
								...
								$rtfeldman$elm_css$Css$url(image.src)),
								...
								$author$project$Style$h64,
								$author$project$Style$w64
							]))
					]),
				_List_Nil),
				chipView
...
var $author$project$Style$bgGray1 = $rtfeldman$elm_css$Css$backgroundColor($author$project$Style$gray1);
var $author$project$Style$gray4 = A3($rtfeldman$elm_css$Css$rgb, 247, 247, 247);
var $author$project$Style$bgGray4 = $rtfeldman$elm_css$Css$backgroundColor($author$project$Style$gray4);
var $rtfeldman$elm_css$Html$Styled$Attributes$class = $rtfeldman$elm_css$Html$Styled$Attributes$stringProperty('className');
var $author$project$Style$g1 = A2($rtfeldman$elm_css$Css$property, 'gap', '0.25rem');
var $rtfeldman$elm_css$Css$right = $rtfeldman$elm_css$Css$prop1('right');
var $author$project$Style$right0 = $rtfeldman$elm_css$Css$right($rtfeldman$elm_css$Css$zero);
var $author$project$Style$textBlack = $rtfeldman$elm_css$Css$color(
	A3($rtfeldman$elm_css$Css$rgb, 0, 0, 0));
var $rtfeldman$elm_css$Css$top = $rtfeldman$elm_css$Css$prop1('top');
var $author$project$Style$top0 = $rtfeldman$elm_css$Css$top($rtfeldman$elm_css$Css$zero);
var $rtfeldman$elm_css$Css$zIndex = $rtfeldman$elm_css$Css$prop1('z-index');
var $author$project$Style$z1 = $rtfeldman$elm_css$Css$zIndex(
	$rtfeldman$elm_css$Css$int(10));
var $author$project$View$ProductCard$view = F2(
	function (productCard, body) {
		var textColor = function () {
			var _v2 = productCard.color;
			if (_v2.$ === 'Color__Light') {
				return $author$project$Style$textBlack;
			} else {
				return $author$project$Style$textWhite;
			}
		}();
		var hoverOverChip = function () {
			var _v1 = productCard.hoverOverChip;
			if (_v1.$ === 'Just') {
				var chip = _v1.a;
				return A2(
					$rtfeldman$elm_css$Html$Styled$div,
					_List_fromArray(
						[
							$rtfeldman$elm_css$Html$Styled$Attributes$css(
							_List_fromArray(
								[$author$project$Style$top0, $author$project$Style$right0, $author$project$Style$absolute, $author$project$Style$z1])),
							$rtfeldman$elm_css$Html$Styled$Attributes$class('hover-over-chip')
						]),
					_List_fromArray(
						[chip]));
			} else {
		...
		var bg = function () {
			var _v0 = productCard.color;
			if (_v0.$ === 'Color__Light') {
				return $author$project$Style$bgGray4;
			} else {
		...
		return A2(
			...
			_List_fromArray(
				[
					$rtfeldman$elm_css$Html$Styled$Attributes$css(
					_List_fromArray(
						[bg, textColor, $author$project$Style$relative, $author$project$Style$col, $author$project$Style$itemsCenter, $author$project$Style$p2, $author$project$Style$g1])),
					$rtfeldman$elm_css$Html$Styled$Attributes$class('product-card')
				]),
			A2($elm$core$List$cons, hoverOverChip, body));
	});
var $author$project$View$ProductCard$Image$withChip = F2(
	function (chip, image) {
		return _Utils_update(
			image,
			{
...
var $author$project$View$ProductCard$withHoverOverChip = F2(
	function (chip, pc) {
		return _Utils_update(
			pc,
			{
				hoverOverChip: $elm$core$Maybe$Just(chip)
			});
	});
var $author$project$Main$productView = F2(
	function (model, product) {
		switch (product.$) {
			case 'Product__PhoneCase':
				var phoneCaseColorOption = function (colorOption) {
					return $author$project$View$ProductCard$Swatch$color(
						{
							onClick: $author$project$Main$ClickedPhoneCaseColorOption(colorOption),
							rgb: function () {
								switch (colorOption.$) {
									case 'PCCO__Red':
							...
							selected: _Utils_eq(colorOption, model.selectedPhoneCaseColorOption)
						});
				};
				return A2(
					$author$project$View$ProductCard$view,
					A2($author$project$View$ProductCard$withHoverOverChip, $author$project$View$ProductCard$showInsideChip, $author$project$View$ProductCard$default),
					_List_fromArray(
						[
							$author$project$View$ProductCard$Image$toHtml(
							$author$project$View$ProductCard$Image$simple('https://bellroy-product-images.imgix.net/bellroy_dot_com_range_page_image/USD/PECA-BIC-502/0?auto=format&fit=max&w=640')),
							$author$project$View$ProductCard$titleView('Bio Phone Case'),
							$author$project$View$ProductCard$priceView('$19'),
							$author$project$View$ProductCard$swatchesView(
							A2(
								$elm$core$List$map,
								phoneCaseColorOption,
								_List_fromArray(
									[$author$project$Main$PCCO__Red, $author$project$Main$PCCO__Green, $author$project$Main$PCCO__Blue]))),
							$author$project$View$ProductCard$descriptionView('Slim protection from your iphone')
						]));
			case 'Product__Bag':
				var bagColorView = function (bagColorOption) {
					return $author$project$View$ProductCard$Swatch$color(
						{
							onClick: $author$project$Main$ClickedBagColorOption(bagColorOption),
							rgb: function () {
								if (bagColorOption.$ === 'BCO__Maroon') {
									return _Utils_Tuple3(128, 0, 0);
								} else {
									return _Utils_Tuple3(0, 165, 200);
								}
							}(),
							selected: _Utils_eq(bagColorOption, model.selectedBagColorOption)
						});
				};
				return A2(
					$author$project$View$ProductCard$view,
					$author$project$View$ProductCard$default,
					_List_fromArray(
						[
							$author$project$View$ProductCard$Image$toHtml(
							A2(
								$author$project$View$ProductCard$Image$withChip,
								$author$project$View$ProductCard$newChip,
								$author$project$View$ProductCard$Image$simple('https://bellroy-product-images.imgix.net/bellroy_dot_com_range_page_image/USD/BHRA-DNB-243/0?auto=format&fit=max&w=640'))),
							$author$project$View$ProductCard$titleView('Cinch Minipack'),
							$author$project$View$ProductCard$priceView('$89'),
							$author$project$View$ProductCard$swatchesView(
							A2(
								$elm$core$List$map,
								bagColorView,
								_List_fromArray(
									[$author$project$Main$BCO__Maroon, $author$project$Main$BCO__Teal])))
						]));
			default:
				var walletColorView = function (colorOption) {
					return $author$project$View$ProductCard$Swatch$color(
						{
							onClick: $author$project$Main$ClickedWalletColorOption(colorOption),
							rgb: function () {
								if (colorOption.$ === 'WCO__Gray') {
									return _Utils_Tuple3(128, 128, 128);
								} else {
									return _Utils_Tuple3(165, 42, 42);
								}
							}(),
							selected: _Utils_eq(colorOption, model.selectedWalletColorOption)
						});
				};
				return A2(
					$author$project$View$ProductCard$view,
					$author$project$View$ProductCard$asDark($author$project$View$ProductCard$default),
					_List_fromArray(
						[
							$author$project$View$ProductCard$Image$toHtml(
							$author$project$View$ProductCard$Image$simple('https://bellroy-product-images.imgix.net/bellroy_dot_com_range_page_image/USD/WXSA-RVN-317/0?auto=format&fit=max&w=640')),
							$author$project$View$ProductCard$titleView('Cinch Minipack'),
							$author$project$View$ProductCard$priceView('$89'),
							$author$project$View$ProductCard$swatchesView(
							A2(
								...
								walletColorView,
								_List_fromArray(
									[$author$project$Main$WCO__Gray, $author$project$Main$WCO__Brown])))
						]));
		}
	});
...
var $author$project$View$Button$Common$Secondary = {$: 'Secondary'};
var $author$project$View$Button$secondary = F2(
	function (label, msg) {
		return A3($author$project$View$Button$make, label, msg, $author$project$View$Button$Common$Secondary);
	});
...
var $author$project$Style$orange1 = A3($rtfeldman$elm_css$Css$rgb, 225, 90, 29);
var $author$project$Style$bgOrange1 = $rtfeldman$elm_css$Css$backgroundColor($author$project$Style$orange1);
...
var $author$project$Style$bgTransparent = $rtfeldman$elm_css$Css$backgroundColor(
	A4($rtfeldman$elm_css$Css$rgba, 0, 0, 0, 0));
var $author$project$Style$borderOrange = $rtfeldman$elm_css$Css$borderColor($author$project$Style$orange1);
var $rtfeldman$elm_css$Css$fontWeight = function (_v0) {
	var value = _v0.value;
	return A2($rtfeldman$elm_css$Css$property, 'font-weight', value);
};
var $author$project$Style$fontWeight800 = $rtfeldman$elm_css$Css$fontWeight(
	$rtfeldman$elm_css$Css$int(800));
var $author$project$Style$none = $author$project$Style$batch(_List_Nil);
var $author$project$Style$textOrange = $rtfeldman$elm_css$Css$color($author$project$Style$orange1);
var $author$project$View$Button$Common$styles = function (variant) {
	var textColor = function () {
		if (variant.$ === 'Primary') {
			return $author$project$Style$textWhite;
		} else {
			return $author$project$Style$textOrange;
		}
	}();
	var fontWeight = function () {
		if (variant.$ === 'Primary') {
			return $author$project$Style$fontWeight800;
		} else {
			return $author$project$Style$none;
		}
	}();
	var bgColor = function () {
		if (variant.$ === 'Primary') {
			return $author$project$Style$bgOrange1;
		} else {
			return $author$project$Style$bgTransparent;
		}
	}();
	return _List_fromArray(
		[bgColor, $author$project$Style$rounded, textColor, fontWeight, $author$project$Style$border, $author$project$Style$borderOrange, $author$project$Style$pointerCursor]);
};
	...
	return A2(
		...
		_List_fromArray(
			[
				...
				_List_fromArray(
					[
						$author$project$Style$batch(
						$author$project$View$Button$Common$styles(button.variant)),
						$author$project$Style$py2,
						$author$project$Style$px4
					])),
				$rtfeldman$elm_css$Html$Styled$Events$onClick(button.onClick)
			]),
		_List_fromArray(
			[
...
var $author$project$Style$orange0 = $rtfeldman$elm_css$Css$hex('#c75724');
var $author$project$Style$bgOrange0 = $rtfeldman$elm_css$Css$backgroundColor($author$project$Style$orange0);
...
var $author$project$Style$shadow = A2($rtfeldman$elm_css$Css$property, 'box-shadow', '0 27px 15px -17px rgba(0,0,0,.3), 0 2px 4px rgba(0,0,0,.3)');
var $author$project$Style$textMd = $rtfeldman$elm_css$Css$batch(
	_List_fromArray(
		[
			$rtfeldman$elm_css$Css$fontSize(
...
var $author$project$View$Button$Big$toHtml = function (button) {
	return A2(
		$rtfeldman$elm_css$Html$Styled$button,
		_List_fromArray(
			[
				...
				_List_fromArray(
					[
						$author$project$Style$wFull,
						$author$project$Style$batch(
						$author$project$View$Button$Common$styles($author$project$View$Button$Common$Primary)),
						$author$project$Style$shadow,
						A2($rtfeldman$elm_css$Css$property, 'transition', 'background-color 0.1s ease'),
						$author$project$Style$py2,
						$author$project$Style$px4,
						$author$project$Style$textMd,
						$author$project$Style$hover(
						_List_fromArray(
							[$author$project$Style$bgOrange0]))
					])),
				$rtfeldman$elm_css$Html$Styled$Events$onClick(button.onClick)
			]),
		_List_fromArray(
...
var $author$project$View$ProductCard$Grid$view = function (body) {
	return A2(
		$rtfeldman$elm_css$Html$Styled$div,
		_List_fromArray(
			[
				...
				_List_fromArray(
					[
						...
						A2($rtfeldman$elm_css$Css$property, 'grid-template-columns', 'repeat(auto-fill, minmax(286px, 1fr))'),
						$author$project$Style$g4
					]))
			]),
		body);
};
var $author$project$Main$componentExampleView = F2(
		...
		return A2(
			...
			_List_fromArray(
				[
					$rtfeldman$elm_css$Html$Styled$Attributes$css(
					_List_fromArray(
						[$author$project$Style$flex1, $author$project$Style$g4, $author$project$Style$col]))
				]),
			function () {
				switch (component.$) {
					case 'Component__Button':
						return _List_fromArray(
							[
								A2(
								$rtfeldman$elm_css$Html$Styled$div,
								...
								_List_fromArray(
									[
										...
										A2(
											$author$project$View$Button$disable,
											false,
											A2($author$project$View$Button$primary, 'Hello', $author$project$Main$ClickedHello))),
										$author$project$View$Button$toHtml(
										A2($author$project$View$Button$primary, 'Hi', $author$project$Main$ClickedHello)),
										$author$project$View$Button$toHtml(
										A2($author$project$View$Button$secondary, 'Show more +', $author$project$Main$ClickedHello))
									])),
								A2(
								$rtfeldman$elm_css$Html$Styled$div,
								_List_fromArray(
								...
								_List_fromArray(
									[
										$author$project$View$Button$Big$toHtml(
										A2($author$project$View$Button$Big$primary, 'ADD TO CART', $author$project$Main$ClickedAddToCart))
									]))
							]);
					case 'Component__Collapsible':
						return _List_fromArray(
							[
								A2(
								$rtfeldman$elm_css$Html$Styled$div,
								_List_fromArray(
									[
										$rtfeldman$elm_css$Html$Styled$Attributes$css(
										_List_fromArray(
											[$author$project$Style$borderB, $author$project$Main$borderColor]))
									]),
								A2(
									$elm$core$List$map,
									$author$project$Main$collapsibleExampleView(model.openCollapsibles),
									$author$project$Main$allCollapsibleExamples))
							]);
					default:
						return _List_fromArray(
							[
								$author$project$View$ProductCard$Grid$view(
								A2(
									$elm$core$List$map,
									$author$project$Main$productView(model),
									$elm$core$List$concat(
										A2($elm$core$List$repeat, 4, $author$project$Main$allProducts))))
							]);
				}
			}());
	});
...
var $author$project$Main$componentView = F2(
	function (model, component) {
		var description = function () {
			switch (component.$) {
				case 'Component__Button':
					return 'I decided to make Button and BigButton separate modules. The buttons are superficially very similar, but I found the small implementation details of the two different enough that I did not want to over complicate a single Button module meant to support both kinds of buttons. I did however, make a View.Button.Common` module that contains their similar parts, such as their colors, common styling, and variants (primary, secondary).';
				case 'Component__Collapsible':
					return 'To users, it looks like the collapsible UI element contains the things that collapse and expand. As a developer, this makes it tempting to make the Collapsible module take in the content that will expand and collapse as an argument. But there are some issues I forsee with that, so I made the collapsible argument very dumbed down. Nothing expands or collapses, the only thing that changes is the chevron arrow spins around. Expanding and collapsible content is handled by an if statement at the call site- which I don\'t think is any harder than passing in the content.';
				default:
					return 'These kinds of components are really dangerous in my experience. They have a lot of details. Every time a detail is added, the module gets more complicated and fragile. To mitigate these risks, I have learned the \"bag of tools\" approach to API design. That means, rather than exposing a single function that takes a lot of individual details as parameters; instead expose lots of small functions that the user can use together. It may be the case that the small functions are used together in very standard and predictable ways, which in some ways translates to more boilerplate at the call-site, but that is a worthwhile trade off for stability in my opinion.';
			}
		}();
		...
		var codeSample = function () {
			switch (component.$) {
				case 'Component__Button':
					return $author$project$Main$buttonCodeExample;
				case 'Component__Collapsible':
					return $author$project$Main$collapsibleCodeExample;
				default:
					return $author$project$Main$productCardExample;
			}
		}();
		var codeHtml = function () {
			var _v0 = $pablohirafuji$elm_syntax_highlight$SyntaxHighlight$elm(codeSample);
			if (_v0.$ === 'Ok') {
				var code = _v0.a;
		...
		return A2(
			...
			_List_fromArray(
				[
					$rtfeldman$elm_css$Html$Styled$Attributes$css(
					_List_fromArray(
						[$author$project$Style$col, $author$project$Style$g2]))
				]),
			_List_fromArray(
				[
					A2(
					...
					_List_fromArray(
						[
							$rtfeldman$elm_css$Html$Styled$Attributes$css(
							_List_fromArray(
								[$author$project$Style$textLg]))
						]),
					_List_fromArray(
						[
							$rtfeldman$elm_css$Html$Styled$text(componentName)
						])),
					A2(
					$rtfeldman$elm_css$Html$Styled$div,
					_List_fromArray(
					...
					_List_fromArray(
						[
							...
							A2($author$project$Main$componentExampleView, model, component)
						]))
				]));
	});
...
var $author$project$View$ProductCard$globalStyles = _List_fromArray(
	[
		A2(
...
var $author$project$Main$globalStyles = $rtfeldman$elm_css$Css$Global$global(
	_Utils_ap(
		_List_fromArray(
			[
				$rtfeldman$elm_css$Css$Global$body(
				_List_fromArray(
					[$author$project$Style$m0, $author$project$Style$p4, $author$project$Style$col, $author$project$Style$g4])),
				$rtfeldman$elm_css$Css$Global$everything(
				_List_fromArray(
					[
						$rtfeldman$elm_css$Css$fontFamilies(
						_List_fromArray(
							['GTUltra', 'Lato', '\"Noto Sans\"', '\"Noto Sans JP\"', '\"Noto Sans KR\"', '\"Noto Sans SC\"', '\"Noto Sans TC\"', '\"ui - sans - serif\"', '\"system - ui\"', '\"sans - serif\"', '\"Apple Color Emoji\"', '\"Segoe UI Emoji\"', '\"Segoe UI Symbol\"', '\"Noto Color Emoji\"']))
					]))
			]),
		$author$project$View$ProductCard$globalStyles));
var $rtfeldman$elm_css$Html$Styled$Attributes$href = function (url) {
	return A2($rtfeldman$elm_css$Html$Styled$Attributes$stringProperty, 'href', url);
};
var $author$project$Main$introText = 'Making components is tricky. The reason to make re-usable components, is to unite different parts of your software under one common code source. This way, when changes are made to the component, they are reflected at all the places the component is used. Let me spell that out in detail, because it is not intuitive. Most of the time, most programmers think that if two things are the same (two buttons, for example), they should use the same code. This is true only to the extent that we expect the buttons to change together through out the life span of the project. If two buttons are identical, but we know that one button will evolve over time in ways that will interfere with the implementation details of the other button, then the two buttons should not be based on a re-usable component. Conversely, if two things are not the same, but maybe share one important attribute, such as their width, they should be based on re-usable code. That way, if we need to change the width, all things that share that width will change together, regardless as to whether those things are in any sense "the same".\n\nFurthermore, this question of "do these things change together" guides not only the decision of whether to implement something as a re-usable component, but which parts should be re-usable. All modals, for example, are all similar in their placement on the screen, their general layout, and their behavior of closing when clicked outside of. But beyond that, they are pretty different, and might have wildly different content in the body of the modal. Given these details, I like to make modal components re-use code for the container of the modal, but leave the body of the internal content of a modal pretty open with few requirements.';
...
var $author$project$Style$whitespacePreWrap = $rtfeldman$elm_css$Css$whiteSpace($rtfeldman$elm_css$Css$preWrap);
		...
		[
			...
			_List_fromArray(
				[
					$rtfeldman$elm_css$Html$Styled$Attributes$css(
					_List_fromArray(
						[$author$project$Main$maxWidth, $author$project$Style$whitespacePreWrap]))
				]),
			_List_fromArray(
				[
					$rtfeldman$elm_css$Html$Styled$text($author$project$Main$introText)
				]))
		]));
var $rtfeldman$elm_css$Html$Styled$span = $rtfeldman$elm_css$Html$Styled$node('span');
var $author$project$Style$textXl = $rtfeldman$elm_css$Css$batch(
	_List_fromArray(
		[
			$rtfeldman$elm_css$Css$fontSize(
			$rtfeldman$elm_css$Css$rem(1.25)),
...
var $author$project$Main$view = function (model) {
	return _Utils_ap(
					...
					[
						...
						_List_fromArray(
							[
								$rtfeldman$elm_css$Html$Styled$Attributes$css(
								_List_fromArray(
									[$author$project$Style$textXl]))
							]),
						_List_fromArray(
							[
								$rtfeldman$elm_css$Html$Styled$text('Bellroy Components Examples - Chad Stearns')
							])),
						A2(
						$rtfeldman$elm_css$Html$Styled$a,
						_List_fromArray(
							[
								$rtfeldman$elm_css$Html$Styled$Attributes$href('https://github.com/Chadtech/component-examples'),
								$rtfeldman$elm_css$Html$Styled$Attributes$css(
								_List_fromArray(
									[$author$project$Style$textXl]))
							]),
						_List_fromArray(
							[
								$rtfeldman$elm_css$Html$Styled$text('See the source Code here')
							]))
					])),
		...
		A2(
			$elm$core$List$map,
			$author$project$Main$componentView(model),
			$author$project$Main$allComponents));
};
...
var $author$project$Main$init = function (json) {
	var model = {openCollapsibles: _List_Nil, selectedBagColorOption: $author$project$Main$BCO__Teal, selectedPhoneCaseColorOption: $author$project$Main$PCCO__Red, selectedWalletColorOption: $author$project$Main$WCO__Gray};
...
var $author$project$Main$update = F2(
	function (msg, model) {
		switch (msg.$) {
			case 'ClickedCollapsible':
				var example = msg.a;
				return _Utils_Tuple2(
					_Utils_update(
						model,
						{
							openCollapsibles: A2($elm$core$List$member, example, model.openCollapsibles) ? A2(
								$elm$core$List$filter,
								$elm$core$Basics$neq(example),
								model.openCollapsibles) : A2($elm$core$List$cons, example, model.openCollapsibles)
						}),
			...
			case 'ClickedHello':
				return _Utils_Tuple2(model, $elm$core$Platform$Cmd$none);
			case 'ClickedBagColorOption':
				var bagColorOption = msg.a;
				return _Utils_Tuple2(
					_Utils_update(
						model,
						{selectedBagColorOption: bagColorOption}),
					$elm$core$Platform$Cmd$none);
			case 'ClickedPhoneCaseColorOption':
				var phoneCaseColorOption = msg.a;
				return _Utils_Tuple2(
					_Utils_update(
						model,
